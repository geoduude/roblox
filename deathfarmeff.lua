...
local Tween = game:GetService("TweenService"):Create(LocalPlayer.Character.Collision, TweenInfo.new((LocalPlayer.Character.Collision.Position - Vector3.new(0, 2, -4)).Magnitude / 19, Enum.EasingStyle.Linear), {["CFrame"] = CFrame.new(0, 2, -6)})
Tween:Play()
Tween.Completed:Wait()
