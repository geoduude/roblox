...
local Tween = game:GetService("TweenService"):Create(LocalPlayer.Character.Collision, TweenInfo.new((LocalPlayer.Character.Collision.Position - Vector3.new(0, 2, -6)).Magnitude / 25, Enum.EasingStyle.Linear), {["CFrame"] = CFrame.new(0, 2, -6)})
Tween:Play()
Tween.Completed:Wait()

local TweenToKey = game:GetService("TweenService"):Create(LocalPlayer.Character.Collision, TweenInfo.new((LocalPlayer.Character.Collision.Position - Vector3.new(-11.5, 2, -45)).Magnitude / 25, Enum.EasingStyle.Linear), {["CFrame"] = CFrame.new(-11.5, 2, -45)})
TweenToKey:Play()
...
local PrepareTweenToDoor = game:GetService("TweenService"):Create(LocalPlayer.Character.Collision, TweenInfo.new((LocalPlayer.Character.Collision.Position - Vector3.new(-4, 2, -48.7)).Magnitude / 25, Enum.EasingStyle.Linear), {["CFrame"] = CFrame.new(-4, 2, -48.7)})
PrepareTweenToDoor:Play()
PrepareTweenToDoor.Completed:Wait()

local TweenToDoor = game:GetService("TweenService"):Create(LocalPlayer.Character.Collision, TweenInfo.new((LocalPlayer.Character.Collision.Position - Vector3.new(15.7, 2, -48.7)).Magnitude / 25, Enum.EasingStyle.Linear), {["CFrame"] = CFrame.new(15.7, 2, -48.7)})
TweenToDoor:Play()
